...
var GetCrossListingsCmd = &cobra.Command{
	...
	Example: "twelvedata cross-listings --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetEarliestTimestampCmd = &cobra.Command{
	...
	Example: "twelvedata earliest-timestamp --symbol AAPL --interval 1day",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetSymbolSearchCmd = &cobra.Command{
	...
	Example: "twelvedata symbol-search --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
func init() {
	...
	_ = GetCrossListingsCmd.MarkFlagRequired("symbol")
	...
	_ = GetSymbolSearchCmd.MarkFlagRequired("symbol")
