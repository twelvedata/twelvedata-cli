...
var GetDirectHoldersCmd = &cobra.Command{
	...
	Example: "twelvedata direct-holders --symbol AAPL",
...
var GetEdgarFilingsArchiveCmd = &cobra.Command{
	...
	Example: "twelvedata edgar-filings-archive --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetFundHoldersCmd = &cobra.Command{
	...
	Example: "twelvedata fund-holders --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetInsiderTransactionsCmd = &cobra.Command{
	...
	Example: "twelvedata insider-transactions --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetInstitutionalHoldersCmd = &cobra.Command{
	...
	Example: "twelvedata institutional-holders --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetTaxInfoCmd = &cobra.Command{
	...
	Example: "twelvedata tax-info --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
