...
var GetTimeSeriesMamaCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if cmd.Flags().Changed("fast-limit") {
			v, _ := cmd.Flags().GetFloat64("fast-limit")
			req = req.FastLimit(v)
		}

		if cmd.Flags().Changed("slow-limit") {
			v, _ := cmd.Flags().GetFloat64("slow-limit")
			req = req.SlowLimit(v)
		}
...
var GetTimeSeriesSarCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if cmd.Flags().Changed("acceleration") {
			v, _ := cmd.Flags().GetFloat64("acceleration")
			req = req.Acceleration(v)
		}

		if cmd.Flags().Changed("maximum") {
			v, _ := cmd.Flags().GetFloat64("maximum")
			req = req.Maximum(v)
		}
...
var GetTimeSeriesSarExtCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if cmd.Flags().Changed("start-value") {
			v, _ := cmd.Flags().GetFloat64("start-value")
			req = req.StartValue(v)
		}

		if cmd.Flags().Changed("offset-on-reverse") {
			v, _ := cmd.Flags().GetFloat64("offset-on-reverse")
			req = req.OffsetOnReverse(v)
		}

		if cmd.Flags().Changed("acceleration-limit-long") {
			v, _ := cmd.Flags().GetFloat64("acceleration-limit-long")
			req = req.AccelerationLimitLong(v)
		}

		if cmd.Flags().Changed("acceleration-long") {
			v, _ := cmd.Flags().GetFloat64("acceleration-long")
			req = req.AccelerationLong(v)
		}

		if cmd.Flags().Changed("acceleration-max-long") {
			v, _ := cmd.Flags().GetFloat64("acceleration-max-long")
			req = req.AccelerationMaxLong(v)
		}

		if cmd.Flags().Changed("acceleration-limit-short") {
			v, _ := cmd.Flags().GetFloat64("acceleration-limit-short")
			req = req.AccelerationLimitShort(v)
		}

		if cmd.Flags().Changed("acceleration-short") {
			v, _ := cmd.Flags().GetFloat64("acceleration-short")
			req = req.AccelerationShort(v)
		}

		if cmd.Flags().Changed("acceleration-max-short") {
			v, _ := cmd.Flags().GetFloat64("acceleration-max-short")
			req = req.AccelerationMaxShort(v)
		}
...
var GetTimeSeriesT3maCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if cmd.Flags().Changed("v-factor") {
			v, _ := cmd.Flags().GetFloat64("v-factor")
			req = req.VFactor(v)
		}
...
func init() {
	...
	GetTimeSeriesAdOscCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAdOscCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAdOscCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesAddCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAddCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAddCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesAdxCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAdxCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAdxCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesAdxrCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAdxrCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAdxrCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesApoCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesApoCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesApoCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesAroonCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAroonCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAroonCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesAroonOscCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAroonOscCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAroonOscCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesAtrCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAtrCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAtrCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesAvgCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAvgCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAvgCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesAvgPriceCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesAvgPriceCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesAvgPriceCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesBBandsCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesBBandsCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesBBandsCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesBBandsCmd.Flags().Float64("sd", 0, "Number of standard deviations. Must be at least `1`")
	...
	GetTimeSeriesBetaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesBetaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesBetaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesBopCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesBopCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesBopCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesCciCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesCciCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesCciCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesCeilCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesCeilCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesCeilCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesCmoCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesCmoCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesCmoCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesCoppockCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesCoppockCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesCoppockCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesCorrelCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesCorrelCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesCorrelCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesCrsiCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesCrsiCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesCrsiCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesDemaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesDemaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesDemaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesDivCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesDivCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesDivCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesDpoCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesDpoCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesDpoCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesDxCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesDxCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesDxCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesEmaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesEmaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesEmaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesExpCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesExpCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesExpCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesFloorCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesFloorCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesFloorCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesHeikinashiCandlesCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesHeikinashiCandlesCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesHeikinashiCandlesCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesHlc3Cmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesHlc3Cmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesHlc3Cmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesHtDcPeriodCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesHtDcPeriodCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesHtDcPeriodCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesHtDcPhaseCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesHtDcPhaseCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesHtDcPhaseCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesHtPhasorCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesHtPhasorCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesHtPhasorCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesHtSineCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesHtSineCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesHtSineCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesHtTrendModeCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesHtTrendModeCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesHtTrendModeCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesHtTrendlineCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesHtTrendlineCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesHtTrendlineCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesIchimokuCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesIchimokuCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesIchimokuCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesKamaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesKamaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesKamaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesKeltnerCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesKeltnerCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesKeltnerCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesKstCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesKstCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesKstCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesLinearRegCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesLinearRegCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesLinearRegCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesLinearRegAngleCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesLinearRegAngleCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesLinearRegAngleCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesLinearRegInterceptCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesLinearRegInterceptCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesLinearRegInterceptCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesLinearRegSlopeCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesLinearRegSlopeCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesLinearRegSlopeCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesLnCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesLnCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesLnCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesLog10Cmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesLog10Cmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesLog10Cmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMacdCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMacdCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMacdCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMacdExtCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMacdExtCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMacdExtCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMacdSlopeCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMacdSlopeCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMacdSlopeCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMamaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMamaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMamaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMamaCmd.Flags().Float64("fast-limit", 0, "The limit for the fast moving average.")

	GetTimeSeriesMamaCmd.Flags().Float64("slow-limit", 0, "The limit for the slow moving average.")
	...
	GetTimeSeriesMaxCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMaxCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMaxCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMaxIndexCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMaxIndexCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMaxIndexCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMcGinleyDynamicCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMcGinleyDynamicCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMcGinleyDynamicCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMedPriceCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMedPriceCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMedPriceCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMfiCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMfiCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMfiCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMidPointCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMidPointCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMidPointCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMidPriceCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMidPriceCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMidPriceCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMinCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMinCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMinCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMinIndexCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMinIndexCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMinIndexCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMinMaxCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMinMaxCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMinMaxCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMinMaxIndexCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMinMaxIndexCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMinMaxIndexCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMinusDICmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMinusDICmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMinusDICmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMinusDMCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMinusDMCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMinusDMCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMomCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMomCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMomCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesMultCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesMultCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesMultCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesNatrCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesNatrCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesNatrCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesObvCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesObvCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesObvCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesPercentBCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesPercentBCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesPercentBCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesPercentBCmd.Flags().Float64("sd", 0, "The standard deviation applied in the calculation. Must be at least `1`")
	...
	GetTimeSeriesPivotPointsHLCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesPivotPointsHLCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesPivotPointsHLCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesPlusDICmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesPlusDICmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesPlusDICmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesPlusDMCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesPlusDMCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesPlusDMCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesPpoCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesPpoCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesPpoCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesRocCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesRocCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesRocCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesRocpCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesRocpCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesRocpCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesRocrCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesRocrCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesRocrCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesRocr100Cmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesRocr100Cmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesRocr100Cmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesRsiCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesRsiCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesRsiCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesRvolCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesRvolCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesRvolCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesSarCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesSarCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesSarCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesSarCmd.Flags().Float64("acceleration", 0, "The rate of change in the indicator's values.")
	...
	GetTimeSeriesSarExtCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesSarExtCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesSarExtCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesSarExtCmd.Flags().Float64("start-value", 0, "The initial value for the indicator calculation.")

	GetTimeSeriesSarExtCmd.Flags().Float64("offset-on-reverse", 0, "The adjustment applied when the indicator's direction changes.")

	GetTimeSeriesSarExtCmd.Flags().Float64("acceleration-limit-long", 0, "The maximum acceleration value for long positions.")

	GetTimeSeriesSarExtCmd.Flags().Float64("acceleration-long", 0, "The acceleration value for long positions.")

	GetTimeSeriesSarExtCmd.Flags().Float64("acceleration-max-long", 0, "The highest allowed acceleration for long positions.")

	GetTimeSeriesSarExtCmd.Flags().Float64("acceleration-limit-short", 0, "The maximum acceleration value for short positions.")

	GetTimeSeriesSarExtCmd.Flags().Float64("acceleration-short", 0, "The acceleration value for short positions.")

	GetTimeSeriesSarExtCmd.Flags().Float64("acceleration-max-short", 0, "The highest allowed acceleration for short positions.")
	...
	GetTimeSeriesSmaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesSmaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesSmaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesSqrtCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesSqrtCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesSqrtCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesStdDevCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesStdDevCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesStdDevCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesStochCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesStochCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesStochCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesStochFCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesStochFCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesStochFCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesStochRsiCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesStochRsiCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesStochRsiCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesSubCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesSubCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesSubCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesSumCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesSumCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesSumCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesSuperTrendCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesSuperTrendCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesSuperTrendCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesSuperTrendHeikinAshiCandlesCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesSuperTrendHeikinAshiCandlesCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesSuperTrendHeikinAshiCandlesCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesT3maCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesT3maCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesT3maCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesT3maCmd.Flags().Float64("v-factor", 0, "The factor used to adjust the indicator's volatility. Takes values in the range from `0` to `1`")
	...
	GetTimeSeriesTRangeCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesTRangeCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesTRangeCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesTemaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesTemaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesTemaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesTrimaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesTrimaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesTrimaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesTsfCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesTsfCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesTsfCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesTypPriceCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesTypPriceCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesTypPriceCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesUltOscCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesUltOscCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesUltOscCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesVarCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesVarCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesVarCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesVwapCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesVwapCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesVwapCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesVwapCmd.Flags().Float64("sd", 0, "The standard deviation applied in the calculation. Must be greater than `0`. Recommended value is `2`. This parameter is only used together with `sd-time-period`.")
	...
	GetTimeSeriesWclPriceCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesWclPriceCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesWclPriceCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesWillRCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesWillRCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesWillRCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
	...
	GetTimeSeriesWmaCmd.Flags().String("timezone", "", "Timezone at which output datetime will be displayed. Supports:\n1. Exchange for local exchange time\n2. UTC for datetime at universal UTC standard\n3. Timezone name according to the IANA Time Zone Database. E.g. America/New_York, Asia/Singapore. Full list of timezones can be found here\nInterval Limitation: The timezone parameter is only applicable for intraday intervals (less than 1 day). For intervals of 1day, 1week, or 1month, the timezone parameter is ignored, and data is strictly returned in the Exchange local time.\nTake note that the IANA Timezone name is case-sensitive")

	GetTimeSeriesWmaCmd.Flags().String("start-date", "", "Can be used separately and together with `end-date`. Format `2006-01-02` or `2006-01-02T15:04:05` Default location:\nForex and Cryptocurrencies - UTC\nStocks - where exchange is located (e.g. for AAPL it will be America/New_York)\nBoth parameters take into account if timezone parameter is provided.\nIf timezone is given then, start_date and end_date will be used in the specified location Examples:\n1. &symbol=AAPL&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 New York time up to current date\n2. &symbol=EUR/USD&timezone=Asia/Singapore&start_date=2019-08-09T15:50:00&…\nReturns all records starting from 2019-08-09T15:50:00 Singapore time up to current date\n3. &symbol=ETH/BTC&timezone=Europe/Zurich&start_date=2019-08-09T15:50:00&end_date=2019-08-09T15:55:00&...\nReturns all records starting from 2019-08-09T15:50:00 Zurich time up to 2019-08-09T15:55:00")

	GetTimeSeriesWmaCmd.Flags().String("end-date", "", "The ending date and time for data selection, see `start-date` description for details.")
