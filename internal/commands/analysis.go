...
var GetAnalystRatingsLightCmd = &cobra.Command{
	...
	Example: "twelvedata analyst-ratings-light --symbol AAPL",
...
var GetAnalystRatingsUsEquitiesCmd = &cobra.Command{
	...
	Example: "twelvedata analyst-ratings-us-equities --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetEarningsEstimateCmd = &cobra.Command{
	...
	Example: "twelvedata earnings-estimate --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetEpsRevisionsCmd = &cobra.Command{
	...
	Example: "twelvedata eps-revisions --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetEpsTrendCmd = &cobra.Command{
	...
	Example: "twelvedata eps-trend --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetGrowthEstimatesCmd = &cobra.Command{
	...
	Example: "twelvedata growth-estimates --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetPriceTargetCmd = &cobra.Command{
	...
	Example: "twelvedata price-target --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetRecommendationsCmd = &cobra.Command{
	...
	Example: "twelvedata recommendations --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetRevenueEstimateCmd = &cobra.Command{
	...
	Example: "twelvedata revenue-estimate --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
