...
var GetMutualFundsWorldCmd = &cobra.Command{
	...
	Example: "twelvedata mutual-funds-world --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetMutualFundsWorldCompositionCmd = &cobra.Command{
	...
	Example: "twelvedata mutual-funds-world-composition --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetMutualFundsWorldPerformanceCmd = &cobra.Command{
	...
	Example: "twelvedata mutual-funds-world-performance --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetMutualFundsWorldPurchaseInfoCmd = &cobra.Command{
	...
	Example: "twelvedata mutual-funds-world-purchase-info --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetMutualFundsWorldRatingsCmd = &cobra.Command{
	...
	Example: "twelvedata mutual-funds-world-ratings --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetMutualFundsWorldRiskCmd = &cobra.Command{
	...
	Example: "twelvedata mutual-funds-world-risk --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetMutualFundsWorldSummaryCmd = &cobra.Command{
	...
	Example: "twelvedata mutual-funds-world-summary --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
...
var GetMutualFundsWorldSustainabilityCmd = &cobra.Command{
	...
	Example: "twelvedata mutual-funds-world-sustainability --symbol AAPL",
	RunE: func(cmd *cobra.Command, args []string) error {
		api, err := client.New(cmd)
		if err != nil {
			return err
